    ...
    with open(input_file, 'r') as f, open(output_file, 'w') as out_f:
        for line in f:
            if line.startswith('HETATM'):
                ...
                # Adjust atom number formatting based on count
                if atom_number < 10000:
                    parts[1] = f"{atom_number:>5}"
                else:
...
transform_coordinates('30-angstrom-cube-center-Au-corrected.txt', 'transformed_coordinates.txt')