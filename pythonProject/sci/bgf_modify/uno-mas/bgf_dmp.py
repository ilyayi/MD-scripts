...
source_file = 'dmp-au-slab.bgf'
target_file = 'cooked/dmp-slab-done.bgf'
columns_to_replace = [2, 3, 4, 5]
column_widths = [11, 4, 4, 4, 6, 3, 10, 10, 9, 7, 2, 3, 10]  # Adjust this based on your file's actual column count
...
target_file = 'cooked/dmp-slab-done.bgf'
columns_to_replace = [2, 3, 4, 5]
column_widths = [10, 5, 4, 4, 6, 3, 10, 10, 9, 7, 2, 3, 10]  # Adjust this based on your file's actual column count
