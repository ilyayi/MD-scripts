...
source_file = 'actually-cooked/dmp-step-done.bgf'
target_file = 'actually-cooked/dmp-step-done.bgf'
columns_to_replace = []
...
replace_multiple_columns_fixed_width(source_file, target_file, columns_to_replace, 64, 111, column_widths)
...
replace_multiple_columns_fixed_width(source_file, target_file, columns_to_replace, 1012, 1581, column_widths)
