...
target_file = 'ilya-slab-done.bgf'
columns_to_replace = [2, 3, 4, 10]
...
replace_multiple_columns_fixed_width(source_file, target_file, columns_to_replace, 97, 111, column_widths)
...
target_file = 'ilya-slab-done.bgf'
columns_to_replace = []
column_widths = [9, 4, 6, 4, 4, 5, 10, 10, 9, 7, 2, 3, 10]  # Adjust this based on your file's actual column count
...
# Example usage of the function with paths and widths
source_file = '8-chain-dmp-au-edge.bgf'
target_file = 'actually-cooked/nik-slab-done.bgf'
columns_to_replace = []
column_widths = [8, 5, 6, 4, 4, 5, 10, 10, 9, 7, 2, 3, 10]  # Adjust this based on your file's actual column count

replace_multiple_columns_fixed_width(source_file, target_file, columns_to_replace, 1012, 1615, column_widths)
