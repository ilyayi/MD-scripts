...
target_file = 'actually-cooked/dmp-edge-done.bgf'
...
replace_multiple_columns_fixed_width(source_file, target_file, columns_to_replace, 63, 111, column_widths)
...
replace_multiple_columns_fixed_width(source_file, target_file, columns_to_replace, 1012, 2373, column_widths)
