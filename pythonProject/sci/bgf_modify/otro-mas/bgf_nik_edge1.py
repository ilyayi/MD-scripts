...
source_file = 'actually-cooked/nik-slab-done.bgf'
target_file = 'actually-cooked/nik-slab-done.bgf'
columns_to_replace = []
column_widths = [11, 2, 6, 4, 4, 5, 10, 10, 9, 7, 2, 3, 10]  # Adjust this based on your file's actual column count
...
target_file = 'actually-cooked/nik-slab-done.bgf'
columns_to_replace = []
column_widths = [10, 3, 6, 4, 4, 5, 10, 10, 9, 7, 2, 3, 10]  # Adjust this based on your file's actual column count

replace_multiple_columns_fixed_width(source_file, target_file, columns_to_replace, 22, 97, column_widths)
...
target_file = 'actually-cooked/nik-slab-done.bgf'
columns_to_replace = []
column_widths = [10, 3, 8, 2, 4, 5, 10, 10, 9, 7, 2, 3, 10]  # Adjust this based on your file's actual column count

replace_multiple_columns_fixed_width(source_file, target_file, columns_to_replace, 98, 111, column_widths)
...
target_file = 'actually-cooked/nik-slab-done.bgf'
columns_to_replace = []
column_widths = [9, 4, 8, 2, 4, 5, 10, 10, 9, 7, 2, 3, 10]  # Adjust this based on your file's actual column count

replace_multiple_columns_fixed_width(source_file, target_file, columns_to_replace, 112, 1011, column_widths)
...
target_file = 'actually-cooked/nik-slab-done.bgf'
columns_to_replace = []
column_widths = [8, 5, 8, 2, 4, 5, 10, 10, 9, 7, 2, 3, 10]  # Adjust this based on your file's actual column count

replace_multiple_columns_fixed_width(source_file, target_file, columns_to_replace, 1012, 2209, column_widths)
